...
/* Explanation: dishName and dish are both strings that cannot be joined. The
join method can only be called on arrays. We cannot concatenate arrays with the
+ operator because it converts them to strings. We must concatenate arrays with
the concat method. */
