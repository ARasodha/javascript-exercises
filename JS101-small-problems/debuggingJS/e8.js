...
/* Explanation: In the median function on line 9, the sort function
had no parameters passed making it automatically sort the numbers array that
it is called on as strings. Therefore, to fix the issues we had to explicitly
parse the arguments are numbers for them to be sorted as numbers. Only then we
can get the correct median */
